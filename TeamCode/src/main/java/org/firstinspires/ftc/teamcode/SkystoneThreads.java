...
//WIP
//Holds all threads
public class SkystoneThreads {
    public AlignWithSkyStone alignWithSkyStone = new AlignWithSkyStone();

}


//This file will hold all threaded functions that can be used during autonomous
class AlignWithSkyStone extends Thread {
